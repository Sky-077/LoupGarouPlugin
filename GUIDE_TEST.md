...
- [ ] À revalider en jeu : relancer plusieurs parties, y compris rapprochées (comme dans les logs), et vérifier qu'aucun watchdog/gel ne se reproduit à aucune étape (ni pré-génération, ni maisons de vote, ni scattering), même si le temps total reste long sur du matériel contraint.
