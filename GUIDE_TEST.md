...
- [ ] À revalider : relancer plusieurs parties (centre proche et centre excentré) et vérifier qu'aucun blocage/déconnexion ne se reproduit, que le message de préparation (~15s) s'affiche et qu'un `/lg stop` pendant cette fenêtre de 15s fonctionne bien (annule la partie au lieu de dire "aucune partie en cours").
