...
- Autres rôles potentiels du LG UHC de TheGuill (Ancien/Doyen, Idiot du Village, Bouc émissaire, Bienfaiteur, Feu Follet, Imitateur, Joueur de Flûte, Grand Méchant Loup, Loup-Garou Craintif, Loup-Garou Perfide, Vilain Petit Loup, etc.) — décrits par l'utilisateur, à implémenter un par un.
